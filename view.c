...
void V_ParseDamage (void)
{
	...
	cl.cshifts[CSHIFT_DAMAGE].percent += 4*count;
	...
	else if (cl_overlay.value == 1)
	{
		cl.cshifts[CSHIFT_DAMAGE].destcolor[0] = 171;   //r
		cl.cshifts[CSHIFT_DAMAGE].destcolor[1] = 231;     //g
		cl.cshifts[CSHIFT_DAMAGE].destcolor[2] = 255;     //b
	}
	else
	{
		cl.cshifts[CSHIFT_DAMAGE].destcolor[0] = 207;   //r
		cl.cshifts[CSHIFT_DAMAGE].destcolor[1] = 99;     //g
		cl.cshifts[CSHIFT_DAMAGE].destcolor[2] = 43;     //b
	}
